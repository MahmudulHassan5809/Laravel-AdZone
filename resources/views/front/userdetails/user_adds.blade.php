                ...
                <div class="item-info col-lg-8">
                    ...
                    <div class="ad-meta">
                        ...
                        <div class="user-option pull-right">
                            @if (!$add->sold)
                                <a class="edit-item" href="{{ route('user.userdetails.ad_sold',$add->id) }}" data-toggle="tooltip" data-placement="top" title="Sold this ad"><i class="fa fa-edit"></i></a>
                            @endif

                            <a class="edit-item" href="{{ route('user.addpost.edit',$add->id) }}" data-toggle="tooltip" data-placement="top" title="Edit this ad"><i class="fa fa-pencil"></i></a>
                            <form class="d-inline" action="{{ route('user.addpost.destroy',$add->id) }}" method="POST">
                                @csrf
                                {{method_field('DELETE')}}
                                <button
                                class="delete-item btn-danger btn btn-sm" data-toggle="tooltip"
                                data-placement="top"
